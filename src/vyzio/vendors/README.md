...
| Famille (`VendorFamily`) | id | Nom affiché | Mode vie privée | PTZ |
|---|---|---|---|---|
| `TplinkTapo` | `tplink_tapo` | TP-Link Tapo | **Coupure matérielle** (cache objectif + LED éteinte) via KLAP | Oui (C200/C210/C225…) via KLAP — probe requis |
| `Icsee` | `icsee` | ICSee / XMEye | PTZ parking via DVRIP | Oui via DVRIP |
| `V380Pro` | `v380_pro` | V380 PRO | PTZ parking via ONVIF | Oui via ONVIF |
...
VendorCapabilityPreset:
  ...
  Icsee      → [ Ptz/Dvrip, PrivacyMode/PtzParking ]
