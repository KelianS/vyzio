...
namespace Vyzio.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925154134_AddCameraAccountRefusedAt")]
    partial class AddCameraAccountRefusedAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vyzio.Core.Entities.Camera", b =>
                {
                    ...
                    b.Property<DateTime?>("AccountRefusedAt")
                        .HasColumnType("TEXT")
                        .HasColumnName("account_refused_at");
