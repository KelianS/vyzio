import type { NotificationChannelConfig, SaveNotificationChannelConfigRequest } from '../../domain/entities/NotificationChannelConfig'
...
export class SaveNotificationChannelConfig {
  ...
  async execute(channel: string, request: SaveNotificationChannelConfigRequest): Promise<NotificationChannelConfig> {
