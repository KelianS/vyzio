...
- Adapter le modèle IA de détection au matériel (Frigate recommande par ex. YOLOv9 plutôt que le SSD MobileNet embarqué par défaut pour OpenVINO) — nécessite de gérer un catalogue de modèles, leur téléchargement et leur stockage ; écarté de [ADR-34](adr/0034-adaptation-materielle-automatique-du-detecteur-frigate.md), qui se limite au choix du détecteur/FPS sans toucher au modèle.
