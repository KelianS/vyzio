...
- Refondre la hierarchie de navigation et l'architecture de l'information : il n'y a aujourd'hui aucune coherence sur *ou* se configure quoi. Symptome le plus net, constate en livrant [ADR-39](adr/0039-reglages-globaux-surchargeables-par-camera-retention-d-enregistrement.md) : les reglages valables pour toute l'installation ont ete poses dans une entree de la barre laterale de la page Cameras, au milieu de la liste des cameras decouvertes — faute d'endroit correct ou les mettre. La page a ete renommee « Parametres » pour limiter les degats, ce qui ne fait que deplacer l'incoherence (une page « Parametres » dont la fonction principale est d'ajouter des cameras). Repartition actuelle a questionner : « Alertes » est en realite un ecran de reglages, « Expert » n'a pas de perimetre defini, et rien ne distingue *configurer une camera*, *configurer l'installation* et *consulter*. Le desordre est aussi structurel cote code : l'ecran Cameras melange decouverte, onboarding, fiche detaillee et reglages generaux dans un seul composant de plus de mille lignes, avec une union `CameraSelection` qui sert a la fois de selection d'objet et de routage d'ecran. A cadrer avant de coder — c'est une decision d'architecture de l'information, pas un deplacement de boutons ; a mener avec l'item bibliotheque de composants ci-dessous, dont il partage le declencheur.
