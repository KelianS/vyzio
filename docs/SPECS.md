...
- lorsqu'une camera dont le flux passe par RTSP refuse son mot de passe apres son ajout (mot de passe change dans l'application du fabricant, compte efface par une mise a jour), Vyzio cesse de le lui presenter avant qu'elle ne le bannisse, et la camera le dit sur sa fiche comme une cause distincte du "hors ligne", avec l'endroit ou corriger le mot de passe ; une fois corrige ou retabli, Vyzio reessaie une fois ;
