...
- le statut vie privee de chaque camera doit etre clairement visible dans l'interface (icone ou badge distinct de l'etat "hors ligne") ; le libelle du badge doit reflechir la strategie active ("Coupure materielle confirmee" quand la camera a confirme la coupure, "Camera orientee — enregistrement desactive", "Enregistrement desactive") ;
